...
Bluethroat Labs is a security research firm focused on the security of complex distributed systems.

Our work often centers on Trusted Execution Environments (TEEs), where hardware security, cryptography, and distributed protocols intersect, one of the most failure-prone boundaries in modern computing.

The TEE Security Handbook is the result of that research. It captures lessons from studying real systems, identifying vulnerabilities, and working with protocol teams to make TEE-based architectures more robust.

*Several insights in this handbook come directly from vulnerability research conducted across production TEE-based protocols.*
