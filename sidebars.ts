      ...
      items: [
        ...
        },
        {
          ...
          items: [
            {
              type: 'doc',
              id: 'Platforms/04C_aws-nitro-enclaves-workflow',
              label: 'AWS Nitro Enclaves Workflow',
            },
            {
              type: 'doc',
              id: 'Platforms/04D_aws-nitro-threat-vectors-paranoid',
        ...
        {
          type: 'doc',
          id: 'Platforms/04E_dstack-decentralized-cloud-tees',
